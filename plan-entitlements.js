...
(function(){
 ...
 function start(){
  ...
  document.querySelectorAll('[data-upgrade]').forEach(b=>{const target=b.dataset.upgrade;if(target===plan()){b.textContent='Current plan';b.disabled=true;return}if(target==='premium'||target==='ultimate'){b.onclick=e=>{e.preventDefault();checkout(target,b)}}});
  watchSuccess();
 }
